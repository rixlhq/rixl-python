...
class SetupIntentRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new SetupIntentRequestBuilder and sets the default values.
    ...
    def with_url(self,raw_url: str) -> SetupIntentRequestBuilder:
        ...
        Returns: SetupIntentRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return SetupIntentRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class SetupIntentRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
