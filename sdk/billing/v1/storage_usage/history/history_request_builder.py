...
if TYPE_CHECKING:
    from .....models.billingv1.get_storage_usage_history_response import GetStorageUsageHistoryResponse
...
class HistoryRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/billing/v1/storage-usage/history{?days*}", path_parameters)
