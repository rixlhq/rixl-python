...
if TYPE_CHECKING:
    from .....models.billing.v1.get_storage_usage_history_response import GetStorageUsageHistoryResponse
...
class HistoryRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/billing/v1/storage-usage/history{?days*,org_id*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[HistoryRequestBuilderGetQueryParameters]] = None) -> Optional[GetStorageUsageHistoryResponse]:
        """
        GetStorageUsageHistory
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[GetStorageUsageHistoryResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, GetStorageUsageHistoryResponse, None)
