...
if TYPE_CHECKING:
    ...
    from ......models.types.move_project_request import MoveProjectRequest
...
class MoveRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/organization/{orgId}/projects/{projectId}/move", path_parameters)
    
    async def post(self,body: MoveProjectRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Project]:
        """
    ...
    def to_post_request_information(self,body: MoveProjectRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Move a project from one organization to another (if user has access to both)
        param body: Target organization ID
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
