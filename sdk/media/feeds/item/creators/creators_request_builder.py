...
class CreatorsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/media/feeds/{feedId}/creators", path_parameters)
    
    def by_creator_id(self,creator_id: str) -> WithCreatorItemRequestBuilder:
        """
        Gets an item from the rixl_sdk.media.feeds.item.creators.item collection
