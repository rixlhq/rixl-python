...
if TYPE_CHECKING:
    from ........models.videosv1.upload_video_thumbnail_response import UploadVideoThumbnailResponse
...
class ThumbnailRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/media/v1/projects/{projectId}/videos/{videoId}/thumbnail", path_parameters)
    
    async def put(self,body: MultipartBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UploadVideoThumbnailResponse]:
        """
        Replaces the thumbnail image for an existing video.
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[UploadVideoThumbnailResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, UploadVideoThumbnailResponse, None)
