...
class WithLangItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/media/v1/projects/{projectId}/videos/{videoId}/audio-tracks/language/{lang}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> WithLangItemRequestBuilder:
        """
        ...
        return WithLangItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithLangItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
