...
class WithLanguage_codeItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/media/v1/projects/{project_id}/videos/{video_id}/audio-tracks/language/{language_code}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> WithLanguage_codeItemRequestBuilder:
        """
        ...
        return WithLanguage_codeItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithLanguage_codeItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
