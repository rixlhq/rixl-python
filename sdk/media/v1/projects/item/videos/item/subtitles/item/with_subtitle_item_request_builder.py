...
class WithSubtitle_ItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/media/v1/projects/{project_id}/videos/{video_id}/subtitles/{subtitle_id}", path_parameters)
    ...
    def with_url(self,raw_url: str) -> WithSubtitle_ItemRequestBuilder:
        """
        ...
        return WithSubtitle_ItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithSubtitle_ItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
