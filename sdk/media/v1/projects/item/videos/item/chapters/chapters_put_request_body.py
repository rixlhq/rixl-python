...
if TYPE_CHECKING:
    from ........models.videos.v1.chapter import Chapter

@dataclass
class ChaptersPutRequestBody(Parsable):
    # The chapters property
    chapters: Optional[list[Chapter]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ChaptersPutRequestBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ChaptersPutRequestBody
        """
