...
if TYPE_CHECKING:
    ...
    from .chapters_put_request_body import ChaptersPutRequestBody
...
class ChaptersRequestBuilder(BaseRequestBuilder):
    ...
    async def put(self,body: ChaptersPutRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[VideoChapters]:
        """
        UpdateVideoChapters
    ...
    def to_put_request_information(self,body: ChaptersPutRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        UpdateVideoChapters
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
