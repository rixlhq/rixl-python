...
class ImagesRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/media/images{?limit*,offset*,order*,sort*}", path_parameters)
    
    def by_image_id(self,image_id: str) -> WithImageItemRequestBuilder:
        """
        Gets an item from the rixl_sdk.media.images.item collection
