...
class UserinfoRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/auth/v1/userinfo", path_parameters)
    ...
    @dataclass
    class UserinfoRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
