...
if TYPE_CHECKING:
    ...
    from .......models.gateway.membership_state_body import MembershipStateBody
...
class StateRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/auth/v1/memberships/{orgId}/membership/state", path_parameters)
    
    async def put(self,body: MembershipStateBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MembershipMutation]:
        """
    ...
    def to_put_request_information(self,body: MembershipStateBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Accepts or declines the authenticated user's pending invitation to the organization. Used from inside the dashboard; the public token flow is /auth/v1/invitations/{token}/accept|decline.
        param body: New membership state
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class StateRequestBuilderPutRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
