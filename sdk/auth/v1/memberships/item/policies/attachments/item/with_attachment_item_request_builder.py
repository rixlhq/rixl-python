...
class WithAttachment_ItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new WithAttachment_ItemRequestBuilder and sets the default values.
    ...
    def with_url(self,raw_url: str) -> WithAttachment_ItemRequestBuilder:
        """
