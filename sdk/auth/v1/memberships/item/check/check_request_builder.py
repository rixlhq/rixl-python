...
if TYPE_CHECKING:
    from ......models.auth.v1.check_membership_response import CheckMembershipResponse
...
class CheckRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/auth/v1/memberships/{org_%2Did}/check{?user_id*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[CheckRequestBuilderGetQueryParameters]] = None) -> Optional[CheckMembershipResponse]:
        """
        CheckMembership
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[CheckMembershipResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, CheckMembershipResponse, None)
