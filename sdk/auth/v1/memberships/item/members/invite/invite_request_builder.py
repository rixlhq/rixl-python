...
if TYPE_CHECKING:
    ...
    from .......models.gateway.invite_member_body import InviteMemberBody
...
class InviteRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/auth/v1/memberships/{orgId}/members/invite", path_parameters)
    
    async def post(self,body: InviteMemberBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[MembershipMutation]:
        """
    ...
    def to_post_request_information(self,body: InviteMemberBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Invites the user with the given username to the organization with the specified role.
        param body: Invitation
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
