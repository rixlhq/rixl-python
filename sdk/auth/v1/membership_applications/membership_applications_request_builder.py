...
class MembershipApplicationsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[MembershipApplicationsRequestBuilderGetQueryParameters]] = None) -> Optional[ListMembershipApplicationsResponse]:
        ...
        Returns: Optional[ListMembershipApplicationsResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, ListMembershipApplicationsResponse, None)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[MembershipApplicationsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        ListMembershipApplications
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> MembershipApplicationsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: MembershipApplicationsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return MembershipApplicationsRequestBuilder(self.request_adapter, raw_url)
    ...
    @dataclass
    class MembershipApplicationsRequestBuilderGetRequestConfiguration(RequestConfiguration[MembershipApplicationsRequestBuilderGetQueryParameters]):
        """
