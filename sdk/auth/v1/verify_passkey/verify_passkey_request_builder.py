...
class VerifyPasskeyRequestBuilder(BaseRequestBuilder):
    ...
    def with_url(self,raw_url: str) -> VerifyPasskeyRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: VerifyPasskeyRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return VerifyPasskeyRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class VerifyPasskeyRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
