...
if TYPE_CHECKING:
    from .........models.posts.v1.post_upload import PostUpload
...
class UploadRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: UploadPostRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[PostUpload]:
        """
        CreatePostUpload
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[PostUpload]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, PostUpload, None)
