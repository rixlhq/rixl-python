...
class CreatorsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/posts/v1/projects/{project_id}/feeds/{feed_id}/posts/creators", path_parameters)
    
    def by_creator_id(self,creator_id: str) -> WithCreator_ItemRequestBuilder:
        """
        Gets an item from the rixl_sdk.posts.v1.projects.item.feeds.item.posts.creators.item collection
