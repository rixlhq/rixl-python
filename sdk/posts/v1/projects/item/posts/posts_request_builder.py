...
class PostsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/posts/v1/projects/{project_id}/posts", path_parameters)
    
    def by_post_id(self,post_id: str) -> WithPost_ItemRequestBuilder:
        """
        Gets an item from the rixl_sdk.posts.v1.projects.item.posts.item collection
