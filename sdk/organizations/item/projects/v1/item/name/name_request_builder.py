...
class NameRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/organizations/{org_id}/projects/v1/{project_id}/name", path_parameters)
    
    async def patch(self,body: NamePatchRequestBody, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Project]:
        """
        UpdateProjectName
