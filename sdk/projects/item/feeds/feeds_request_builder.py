...
if TYPE_CHECKING:
    ...
    from ....models.feedsv1.list_feeds_response import ListFeedsResponse
    from ....models.types.create_feed_request import CreateFeedRequest
...
class FeedsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/projects/{projectId}/feeds{?limit*,offset*}", path_parameters)
    
    def by_feed_id(self,feed_id: str) -> WithFeedItemRequestBuilder:
        """
        Gets an item from the rixl_sdk.projects.item.feeds.item collection
    ...
    async def get(self,body: FeedsGetRequestBody, request_configuration: Optional[RequestConfiguration[FeedsRequestBuilderGetQueryParameters]] = None) -> Optional[ListFeedsResponse]:
        """
    ...
    async def post(self,body: CreateFeedRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[Feed]:
        """
