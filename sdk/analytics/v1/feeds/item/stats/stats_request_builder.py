...
if TYPE_CHECKING:
    from ......models.analytics.v1.feed_stats import FeedStats
...
class StatsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/analytics/v1/feeds/{feed_id}/stats{?range%2Eend*,range%2Estart*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[StatsRequestBuilderGetQueryParameters]] = None) -> Optional[FeedStats]:
        """
        GetFeedStats
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[FeedStats]
        """
        ...
        return await self.request_adapter.send_async(request_info, FeedStats, None)
