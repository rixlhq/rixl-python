...
if TYPE_CHECKING:
    from .....models.analyticsv1.top_feeds_response import TopFeedsResponse
...
class FeedsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/analytics/v1/top/feeds{?end*,limit*,start*}", path_parameters)
