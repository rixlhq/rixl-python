...
if TYPE_CHECKING:
    from .....models.analytics.v1.top_images_response import TopImagesResponse

class ImagesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /analytics/v1/top/images
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/analytics/v1/top/images{?limit*,range%2Eend*,range%2Estart*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ImagesRequestBuilderGetQueryParameters]] = None) -> Optional[TopImagesResponse]:
        """
        GetTopImages
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TopImagesResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, TopImagesResponse, None)
