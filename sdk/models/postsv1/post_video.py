...
@dataclass
class PostVideo(AdditionalDataHolder, Parsable):
    ...
    # The poster property
    poster: Optional[PostImage] = None
    # The width property
    width: Optional[int] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PostVideo:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "file": lambda n : setattr(self, 'file', n.get_object_value(PostFile)),
            ...
            "poster": lambda n : setattr(self, 'poster', n.get_object_value(PostImage)),
