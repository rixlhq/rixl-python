...
class CreateSubscriptionResponse(Parsable):
    ...
    # The stripeCustomerId property
    stripe_customer_id: Optional[str] = None
    # The stripeSubscriptionId property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "stripeCustomerId": lambda n : setattr(self, 'stripe_customer_id', n.get_str_value()),
            "stripeSubscriptionId": lambda n : setattr(self, 'stripe_subscription_id', n.get_str_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("stripeCustomerId", self.stripe_customer_id)
        writer.write_str_value("stripeSubscriptionId", self.stripe_subscription_id)
