...
class PaymentMethodDetails(Parsable):
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "exp_month": lambda n : setattr(self, 'exp_month', n.get_str_value()),
            "exp_year": lambda n : setattr(self, 'exp_year', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("exp_month", self.exp_month)
        writer.write_str_value("exp_year", self.exp_year)
