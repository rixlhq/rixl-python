...
if TYPE_CHECKING:
    ...
    from .calculate_tax_request_metadata import CalculateTaxRequest_metadata
...
class CalculateTaxRequest(Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> CalculateTaxRequest:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: CalculateTaxRequest
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "interval_count": lambda n : setattr(self, 'interval_count', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("interval_count", self.interval_count)
