...
class StorageUsage(Parsable):
    ...
    image_storage_bytes: Optional[str] = None
    ...
    total_storage_bytes: Optional[str] = None
    ...
    video_storage_bytes: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "image_storage_bytes": lambda n : setattr(self, 'image_storage_bytes', n.get_str_value()),
            ...
            "total_storage_bytes": lambda n : setattr(self, 'total_storage_bytes', n.get_str_value()),
            ...
            "video_storage_bytes": lambda n : setattr(self, 'video_storage_bytes', n.get_str_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("image_storage_bytes", self.image_storage_bytes)
        ...
        writer.write_str_value("total_storage_bytes", self.total_storage_bytes)
        ...
        writer.write_str_value("video_storage_bytes", self.video_storage_bytes)
