...
class PlanTaxCalculationResponse(Parsable):
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "calculatedAt": lambda n : setattr(self, 'calculated_at', n.get_datetime_value()),
            ...
            "taxPercentage": lambda n : setattr(self, 'tax_percentage', n.get_float_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_datetime_value("calculatedAt", self.calculated_at)
        ...
        writer.write_float_value("taxPercentage", self.tax_percentage)
