...
class Membership(Parsable):
    ...
    # The organizationFirstName property
    organization_first_name: Optional[str] = None
    # The organizationLastName property
    organization_last_name: Optional[str] = None
    # The organizationUsername property
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "organizationFirstName": lambda n : setattr(self, 'organization_first_name', n.get_str_value()),
            "organizationLastName": lambda n : setattr(self, 'organization_last_name', n.get_str_value()),
            "organizationUsername": lambda n : setattr(self, 'organization_username', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("organizationFirstName", self.organization_first_name)
        writer.write_str_value("organizationLastName", self.organization_last_name)
        writer.write_str_value("organizationUsername", self.organization_username)
