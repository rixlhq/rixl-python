...
@dataclass
class BillingAddressBody(AdditionalDataHolder, Parsable):
    """
    Billing address
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> BillingAddressBody:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: BillingAddressBody
        """
