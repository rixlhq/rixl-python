...
@dataclass
class SubscriptionHistoryItem(AdditionalDataHolder, Parsable):
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "end_date": lambda n : setattr(self, 'end_date', n.get_str_value()),
            ...
            "start_date": lambda n : setattr(self, 'start_date', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("end_date", self.end_date)
        ...
        writer.write_str_value("start_date", self.start_date)
