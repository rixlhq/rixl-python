...
@dataclass
class OrgMember(AdditionalDataHolder, Parsable):
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "invitation_expires_at": lambda n : setattr(self, 'invitation_expires_at', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("invitation_expires_at", self.invitation_expires_at)
