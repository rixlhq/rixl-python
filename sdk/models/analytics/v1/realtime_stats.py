...
class RealtimeStats(Parsable):
    ...
    events_per_minute: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "active_users": lambda n : setattr(self, 'active_users', n.get_str_value()),
            "events_per_minute": lambda n : setattr(self, 'events_per_minute', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("active_users", self.active_users)
        writer.write_str_value("events_per_minute", self.events_per_minute)
