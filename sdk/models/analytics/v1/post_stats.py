...
class PostStats(Parsable):
    ...
    total_watch_time_ms: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "total_watch_time_ms": lambda n : setattr(self, 'total_watch_time_ms', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("total_watch_time_ms", self.total_watch_time_ms)
