...
class ImageStats(Parsable):
    ...
    feed_views: Optional[str] = None
    # The image_id property
    image_id: Optional[str] = None
    # The standalone_views property
    standalone_views: Optional[str] = None
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "feed_views": lambda n : setattr(self, 'feed_views', n.get_str_value()),
            "image_id": lambda n : setattr(self, 'image_id', n.get_str_value()),
            "standalone_views": lambda n : setattr(self, 'standalone_views', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("feed_views", self.feed_views)
        writer.write_str_value("image_id", self.image_id)
        writer.write_str_value("standalone_views", self.standalone_views)
