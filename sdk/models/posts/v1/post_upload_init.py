...
class PostUploadInit(Parsable):
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "content_upload_url": lambda n : setattr(self, 'content_upload_url', n.get_str_value()),
            ...
            "upload_expires": lambda n : setattr(self, 'upload_expires', n.get_datetime_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("content_upload_url", self.content_upload_url)
        ...
        writer.write_datetime_value("upload_expires", self.upload_expires)
