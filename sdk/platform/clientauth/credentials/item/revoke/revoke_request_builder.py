...
if TYPE_CHECKING:
    from ......models.clientauthv1.revoke_client_credential_response import RevokeClientCredentialResponse
...
class RevokeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/platform/clientauth/credentials/{credentialId}/revoke", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[RevokeClientCredentialResponse]:
        """
        Revoke a client credential owned by the authenticated organization
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[RevokeClientCredentialResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, RevokeClientCredentialResponse, None)
