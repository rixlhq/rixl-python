...
class RevokeRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/platform/clientauth/v1/credentials/{credential_id}/revoke{?org_id*}", path_parameters)
    
    async def post(self,request_configuration: Optional[RequestConfiguration[RevokeRequestBuilderPostQueryParameters]] = None) -> Optional[Empty]:
        """
    ...
    def to_post_request_information(self,request_configuration: Optional[RequestConfiguration[RevokeRequestBuilderPostQueryParameters]] = None) -> RequestInformation:
        """
        RevokeClientCredential
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class RevokeRequestBuilderPostRequestConfiguration(RequestConfiguration[RevokeRequestBuilderPostQueryParameters]):
        """
