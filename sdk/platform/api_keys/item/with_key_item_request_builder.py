...
if TYPE_CHECKING:
    from ....models.apikeysv1.delete_api_key_response import DeleteApiKeyResponse
...
class WithKeyItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/platform/api-keys/{keyId}", path_parameters)
    
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeleteApiKeyResponse]:
        """
        Delete an API key owned by the authenticated organization
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[DeleteApiKeyResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, DeleteApiKeyResponse, None)
